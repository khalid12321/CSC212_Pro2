...
public class StockAnalyzerCLI {
	public static void main(String[] args) {
		...
		StockHistory googleStockHistory = loader.loadStockDataFile("C:\\Users\\salma\\eclipse-workspace\\CSC212_Project\\data\\real\\GOOGL.csv");
//		StockHistory googleStockHistory = loader.loadStockDataFile("C:\\Users\\asus\\Desktop\\extra\\examples\\C1.csv");
...
//			endDate = dateFormat.parse("2024-01-06");
		} catch (ParseException e) {
			e.printStackTrace();
			return;
		}
...
//		StockHistoryDataSet dataSet = loader.loadStockDataDir("C:\\Users\\asus\\Desktop\\extra\\examples");
